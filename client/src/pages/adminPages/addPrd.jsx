          ...
          <div id="infoDesc" className="tabContent">
            ...
            <div className='infoItem'>
              ...
              <div className="itemPrice">
                ...
                <input id="productPrice" name='productPrice' type="number" min="0" required
              ...
              <div className="descInfo">
                <div className="descItem">
                  ...
                  <input id="productDesc" name="productDesc" type="text" required
                    value={formData.productDesc} onChange={handleInputChange}
                  />
                </div>
                <div className="descItem">
                  ...
                  <input id="productSpec1" name="productSpec1" type="text" required
                    value={formData.productSpec1} onChange={handleInputChange}
                  />
                </div>
                <div className="descItem">
                  ...
                  <input id="productSpec2" name="productSpec2" type="text" required
                    value={formData.productSpec2} onChange={handleInputChange}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="infoItem itemflexList">
                <div>
                  ...
                  <input id="discountStart" type="datetime-local" name="discountStart"
                    value={formData.discountStart} onChange={handleInputChange}
                  />
                </div>
                <div>
                  ...
                  <input id="discountEnd" type="datetime-local" name="discountEnd"
                    value={formData.discountEnd} onChange={handleInputChange}
                  />
                </div>
              </div>
              <div className="infoItem">
                ...
                <input
                  ...
                  value={formData.discountRate} onChange={handleInputChange}
                />
              </div>
            </div>
          </div>
